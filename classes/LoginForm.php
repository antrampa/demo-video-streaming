 ...
 * @version 1.0
 * @Created Thursday, November 03, 2008

*/



class TLoginForm extends TtblParamAddEditDelete 
{
	var $formWidth;
	var $formHeight;
	var $formBgColor;
	...
	*/
	public function TLoginForm()
	{
		...
		$this->fromFile        = "catalogue_manager.php"; 
	}
	
	
	/*
	*	Δήλωση του αντικειμένου με ορίσματα
	*/
	public function formSettings($frWidth,$frHeight,$frBgColor,$frColor,$frBorderColor,$frFile)
	{
		$this->formWidth       = $frWidth;
		$this->formHeight      = $frHeight;
		$this->formBgColor     = $frBgColor;
	 	$this->formColor       = $frColor;
		$this->formBorderColor = $frBorderColor;
	...
	*/
	...
	/*
	*	Δημιουργεί την φόρμα για Login
	*/
	public function createLoginForm()
	{
		$this->loginForm = "<table width=\"".$this->formWidth."\" height=\"".$this->formHeight."\" bgcolor=\"".$this->formBgColor."\" style=\"border:1px solid ".$this->formBorderColor.";\">  
								<tr>
	...
	{
		echo "<div align=\"center\" width=\"".$this->formWidth."\" style=\"top:50px; z-index:10000;\">";	
		echo "<form name=\"frLogin\" method=\"post\" action=\"loginform_login.php\" >";	
			echo $this->loginForm;
			echo "<input type=\"hidden\" name=\"fromFile\" value=\"".$this->fromFile."\" >";
		echo "</form>";	
