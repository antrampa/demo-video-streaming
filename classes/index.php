<?php
include_once("../define_file.php");								        //parameters of connection
include_once("../classes/tbl_param_class_AddEditDelete.php");				//Classes					
include_once("../classes/myClasses.php");
...
<title>Welcome to DYNAMIC Real Estate Company</title>
