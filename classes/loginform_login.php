...
$myClass->setValue($database_host,$DB_glass_apps,$db_user,$db_pass);								//Σύνδεση με την βάση
//$myClass->printValue();
$connected = $myClass->connectToDatabase();
																									//echo "<br>connected:".$connected."<br>";
...
$sql = "SELECT tbl_param_users_username 
		...
		WHERE tbl_param_users_username = '".$username."' 
		AND tbl_param_users_password = '".$password."' ";
$res = mysql_query($sql,$connected);
...
if( @mysql_num_rows($res) > 0 )		
{
	...
	setcookie("userLoginForm", $username, $expire);
	$myClass->goto($url);
}
else
{
