...
class TMail
{
	...
	public function TMail( $_to = "ambitos2000@yahoo.com",$_cc = "",$_bcc = "", $_text = "",$_subject = "" )
	{
		$this->to = $_to;
		$this->cc = $_cc; 
		$this->bcc = $_bcc;
		$this->from = "Glass Studio <sales@myglassstudio.com>";
		$this->text = $_text;
	...
	/*
	* @sentMailWithBCC($_bccList)
	*
	*/
	public function sentMailWithBCC($_bccList)
	{
		$this->listBcc = implode(",",$_bccList);	
		...
		// Additional headers
		$headers .= 'To: '.$this->to.'' . "\r\n";
		$headers .= 'From: Glass Studio <sales@myglassstudio.com>' . "\r\n";
		$headers .= 'Cc: ambitos2000@yahoo.com' . "\r\n";
		$headers .= 'Bcc: pli663@teiser.gr, antrampa@gmail.com,'.$this->bcc.'' . "\r\n";

		
		$res = mail($this->to,$this->subject,"".$this->text."",$headers);
		return $res;
	}
