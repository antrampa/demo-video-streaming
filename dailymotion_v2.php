<?php
$content = file_get_contents("http://www.dailymotion.com/video/x9hur6_shadow-complex-e3-trailer_videogames");
...
//print_r($headers);
echo "<br>".str_replace('Location: ', '', $headers[8]);
$flv = file_get_contents(str_replace('Location: ', '', $headers[8]));

$file = "flvs/dailymotion.flv";
