...
$url = $videourl;
$pattern = getPatternFromUrl($url);
//$flvUrl = getYouTubeFlvUrl( $pattern );


//$pattern = getPatternFromUrl($videourl);
$videourl = "http://www.youtube.com/v/".$pattern."&hl=en_US&fs=1&";
//http://www.youtube.com/v/5UwDkpFbhBU&hl=en_US&fs=1&
//http://www.youtube.com/v/".$pattern."=en_US&fs=1&";


$result = '<object width="425" height="344"><param name="movie" value="'.$videourl.'"></param><script type="text/javascript">

</script><script type="text/javascript">

</script><script type="text/javascript">

</script><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="'.$videourl.'" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="425" height="344"></embed></object>';


echo $result."<br>".$videourl;
