<?php
//include("include/FLVMetaData.class.php");
//include("include/module.audio-video.flv - Copy.php");

//$myGetid3_flv = new getid3_flv();

//$myFLVMetaData = new FLVMetaData();
?>
...
<head>
    ...
    <script src="js/mootools-1.2.1-core-yc.js" type="text/javascript" language="javascript"></script><script type="text/javascript">
    ...
    <script src="js/mootools-1.2.1-more-yc.js" type="text/javascript" language="javascript"></script>
    <script src="js/lib.js" type="text/javascript" language="javascript"></script>
      ...
      <div id="body-bot">
        <div id="body-top">
          ...
          <div id="gbox">
				...
				<p>		
                <input type="text" name="video_url" id="video_url" size="30" /> 
                <input type="button" name="BttnAtach" value="Attach" style="background-color:#FFF; border:#000 solid 1px; color:#000; font-size:12px; width:100px; cursor:pointer;" onclick="attachVideoUrl('include/attach_video_url.php',document.getElementById('video_url').value,'div_videoplayer');
...
<embed src="http://www.youtube.com/v/u1zgFlCw8Aw" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="425" height="344"></object>
                </div>
                
                <!--
                <object width="480" height="275"><param name="movie" value="http://www.dailymotion.com/swf/xc6ps7"></param><param name="allowFullScreen" value="true"></param><param name="allowScriptAccess" value="always"></param><embed src="http://www.dailymotion.com/swf/xc6ps7" width="480" height="275" allowfullscreen="true" allowscriptaccess="always"></embed></object> 
                
                <br />
                
                <object width="410" height="341" id="veohFlashPlayer" name="veohFlashPlayer"><param name="movie" value="http://www.veoh.com/static/swf/webplayer/WebPlayer.swf?version=AFrontend.5.4.9.1006&permalinkId=e41636&player=videodetailsembedded&videoAutoPlay=0&id=anonymous"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.veoh.com/static/swf/webplayer/WebPlayer.swf?version=AFrontend.5.4.9.1006&permalinkId=e41636&player=videodetailsembedded&videoAutoPlay=0&id=anonymous" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="410" height="341" id="veohFlashPlayerEmbed" name="veohFlashPlayerEmbed"></embed></object>
                -->
                <!--Veoh url -->
                <!--
                <object width="425" height="344"><param name="movie" value="http://www.veoh.com/collection/s14860/watch/e41636"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.veoh.com/collection/s14860/watch/e41636" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true" width="425" height="344"></embed></object>
                -->
                </p>
...
$flvUrl = GrabFlvFromYoutube( $pattern );//getYouTubeFlvUrl( $pattern );

						$myFLVMetaData = new FLVMetaData($flvUrl);//"video.flv"
						$myFLVMetaData->dumpMetaData();
						$myFLVMetaData->getMetaData();
						echo "<br>"; 
						$myFLVMetaData->dumpMetaData();
					*/
					?>
