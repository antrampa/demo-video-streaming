...
<div align="center">
  <table width="740" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      <td align="center" valign="top"><form action="" method="POST">
        <table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td align="right" valign="middle">URL: </td>
            <td valign="middle"><label>
<input name="UTURLTXT" type="text" value="<?php if(isset($_POST['UTURLTXT'])) {echo $_POST['UTURLTXT'];} else {echo "http://www.youtube.com/watch?v=7C0RwEum78w";} ?>" size="60" />            </label></td>
            <td valign="middle"><label>
...
Click on the hyperlink to download the video:
<?php
include_once("generic-vids-downloader-v2.1.php");
echo GetDownloadLink();
?>      </td>
    </tr>
  </table>
