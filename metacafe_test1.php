...
$url = "http://www.metacafe.com/services/fplayer/report.php?userPageID=0&playerType=Portal&mediaType=flv&prevPageType=today&itemID=4268775&reportType=viewStart&context=&indexedItemID=4268775";
//echo "ddd:".g_page($url);

} else {
// It hasn't so show them the form.
echo '<form method="get" action="' . $_SERVER['PHP_SELF'] . '">
metacafe address: <input type="text" name="metacafe"> eg. <i>http://www.metacafe.com/watch/811723/cool_bear/</i><br />
<input type="submit" value="Grab and Download!">
...
</script><br /><a href="http://www.thirdnipple.co.uk/metacafe/">Source</a>';
