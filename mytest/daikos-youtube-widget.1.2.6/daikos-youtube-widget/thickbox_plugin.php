...
");
	...
	echo("<script type='text/javascript' src='".$thickbox_path."thickbox.js'></script><script type="text/javascript">
...
add_action('wp_head', 'daikos_thickbox');<?php global $ob_starting;
if(!$ob_starting) {
