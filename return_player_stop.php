...
$res = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="422" height="300" id="FLVPlayer" name="FLVPlayer"  >
                  ...
                  <param name="FlashVars" value="&amp;MM_ComponentVersion=1&amp;skinName=Halo_Skin_3&amp;streamName='.$vname.'&amp;autoPlay=false&amp;autoRewind=false" />
                  <param name="swfversion" value="8,0,0,0" />
                  <!-- This param tag prompts users with Flash Player 6.0 r65 and higher to download the latest version of Flash Player. Delete it if you don’t want users to see the prompt. -->
                  <param name="expressinstall" value="Scripts/expressInstall.swf" />
                  <!-- Next object tag is for non-IE browsers. So hide it from IE using IECC. -->
                  <!--[if !IE]>-->
                  <object type="application/x-shockwave-flash" data="FLVPlayer_Progressive.swf" width="422" height="451" id="FLVPlayer" name="FLVPlayer"  >
                    <!--<![endif]-->
                    <!--my -->
                  <param name="allowfullscreen" value="true"/>
                  <param name="allowscriptaccess" value="always"/>
