<?php
@session_start();
include("define_file.php");								      
include("classes/tbl_param_class_AddEditDelete.php");				
...
$myClass->setValue($database_host,$DB_video_streaming,$db_user,$db_pass);																							
...
$videodatarate = $_REQUEST['videodatarate'];
$audiodatarate = $_REQUEST['audiodatarate'];
$audiodelay = $_REQUEST['audiodelay'];
$audiocodecid = $_REQUEST['audiocodecid'];
$ACidMap_audiocodecid = $_REQUEST['ACidMap_audiocodecid'];
$videocodecid = $_REQUEST['videocodecid'];
$VCidMap_videocodecid = $_REQUEST['VCidMap_videocodecid'];
$execution_time = $_REQUEST['execution_time'];
//$currentTime = $_REQUEST['currentTime'];                


$sql = "INSERT INTO tbl_ab_videos 
		(
			tbl_ab_videos_url,
			tbl_ab_videos_name,
			tbl_ab_videos_version,
			tbl_ab_videos_duration,
			tbl_ab_videos_size,
			tbl_ab_videos_width,
			tbl_ab_videos_height,
			tbl_ab_videos_framerate,
			tbl_ab_videos_videodatarate,
			tbl_ab_videos_audiodatarate,
			tbl_ab_videos_audiodelay,
			tbl_ab_videos_audiocodecid,
			tbl_ab_videos_acidmap_audiocodecid,
			tbl_ab_videos_videocodecid,
			tbl_ab_videos_vcidmap_videocodecid,
			tbl_ab_videos_execution_time
		...
		(
			...
			'".$audiodelay."',
			'".$audiocodecid."',
			'".$ACidMap_audiocodecid."',
			'".$videocodecid."',
			'".$VCidMap_videocodecid."',
			'".$execution_time."'
			
		)
		";
//tbl_ab_videos_current_time = '".$currentTime."'
$res = mysql_query($sql) or die( mysql_error() );

$url = "index.php?video_url=".$video_url."&res=".$res;
$myClass->goto($url);
