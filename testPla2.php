...
<script src="Scripts/swfobject_modified.js" type="text/javascript"></script><script type="text/javascript">
  ...
  <body>
  <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="322" height="351" id="FLVPlayer">
    <param name="movie" value="FLVPlayer_Progressive.swf" />
    <param name="quality" value="high">
    <param name="wmode" value="opaque">
    <param name="scale" value="noscale">
    <param name="salign" value="lt">
    <param name="FlashVars" value="&amp;MM_ComponentVersion=1&amp;skinName=Halo_Skin_1&amp;streamName=flvs/d7n8GqewJ2M&amp;autoPlay=true&amp;autoRewind=false&amp;allowfullscreen=true&amp;allowscriptaccess=true" />
    <param name="swfversion" value="8,0,0,0">
    <!-- This param tag prompts users with Flash Player 6.0 r65 and higher to download the latest version of Flash Player. Delete it if you don’t want users to see the prompt. -->
    <param name="expressinstall" value="Scripts/expressInstall.swf">
    <!-- Next object tag is for non-IE browsers. So hide it from IE using IECC. -->
    <!--[if !IE]>-->
    <object type="application/x-shockwave-flash" data="FLVPlayer_Progressive.swf" width="322" height="351">
      <!--<![endif]-->
      <param name="quality" value="high">
      <param name="wmode" value="opaque">
      <param name="scale" value="noscale">
...
//-->
  ...
  <a href="#" onClick="document.getElementById('FLVPlayer').sendEvent('PLAY','true');">Play</a>
     <ul>
  <li><a href="#" onClick="document.getElementById('FLVPlayer').sendEvent('PLAY','true');">play</a></li>
  <li><a href="#" onClick="document.getElementById('FLVPlayer').sendEvent('PLAY','false');">pause</a></li>
  <li><a onClick="document.getElementById('FLVPlayer').sendEvent('STOP');">stop</a></li>
