...
<head> 
	...
	<title>Controlling the player from javascript</title> 
 
	<style type="text/css"> 
		body { background-color: #fff; padding: 20px; color:#000; font: 13px/18px Arial, sans-serif; }
		a,h1 { color: #669900; }
		h1,h3 { padding-top: 20px; }
		ul { margin:5px 0 15px 16px; padding:0; list-style-type:square; }
		pre { font-family: monospace; color: #66CC00; }
		#controlbar { 
			margin: 20px 5px;
			padding: 0;
...
<body> 
	...
	<h3>Controlling the player from javascript</h3> 
	<p><script type="text/javascript" src="http://content.bitsontherun.com/players/LJSVMnCF-ALJ3XQCI.js"></script></p> 
	<ul id="controlbar"> 
		...
		<li style="margin-right:0;"><a href="javascript:player.sendEvent('MUTE','true');">mute</a></li> 
	</ul> 
 
	<h3>Tutorial</h3> 
	<p><a href="http://www.bitsontherun.com/tutorials/controlling-player-javascript/">Read the accompanying tutorial</a></p> 
