...
<body>
<p>
  <object  class="swf_holder"type="application/x-shockwave-flash" width="640" height="360" data="/moogaloop_local.swf?clip_id=10198497&server=vimeo.com&autoplay=0&fullscreen=1&show_portrait=0&show_title=0&show_byline=0&color=00ADEF&context=user:647380&context_id=&hd_off=0&buildnum=34588"> 
    <param name="quality" value="high" /> 
    <param name="allowfullscreen" value="true" /> 
    <param name="AllowScriptAccess" value="always" /> 
    <param name="wmode" value="opaque" /> 
    <param name="scale" value="showAll" /> 
    <param name="movie" value="/moogaloop_local.swf?clip_id=10198497&server=vimeo.com&autoplay=0&fullscreen=1&show_portrait=0&show_title=0&show_byline=0&color=00ADEF&context=user:647380&context_id=&hd_off=0&buildnum=34588" /> 
  </object>
</p>
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="400" height="400" id="FLVPlayer">
  ...
  <param name="FlashVars" value="&amp;MM_ComponentVersion=1&amp;skinName=Clear_Skin_1&amp;streamName=asdsad&amp;autoPlay=false&amp;autoRewind=false" />
